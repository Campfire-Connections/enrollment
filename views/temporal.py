...
def load_quarters(request):
    ...
    available_quarters = Quarters.objects.filter(facility=facility, type=faction_quarters_type)
        ...
        tables_with_names = [
            {
                ...
                "create_url": table.get_url(
                    "add", context={"facility_slug": facility.slug, "facility_enrollment_slug": enrollment.slug, "week_slug": week.slug}
                ),
